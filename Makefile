...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/devsolux/clash/constant.Version=$(VERSION)" \
		-X "github.com/devsolux/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
